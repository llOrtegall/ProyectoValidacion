...
export function EditarUsuario ({ user, fun }) {
  ...
  const [userObject, setUserObject] = useState({ names1: '', names2: '', names3: '', names4: '', tel: '', documen: cedula, email: '' })
  ...
  const UsuarioActualizado = () => {
    ...
    return (
      <div className='text-green-800 right-auto font-bold '>
      ...
      <section className='relative'>
        <form className='flex flex-col m-4 p-4 rounded-lg '>
          <div className='flex justify-between'>
            ...
            <input className='mb-2 rounded-lg px-2 ' defaultValue={nombre1} name='names1' />
          </div>
          <div className='flex justify-between'>
            <label className='font-bold pr-8'>Nombre 2: </label>
            <input className='mb-2 rounded-lg px-2 ' defaultValue={nombre2} name='names2' />
          </div>
          <div className='flex justify-between'>
            <label className='font-bold pr-8'>Apellido 1: </label>
            <input className='mb-2 rounded-lg px-2 ' defaultValue={apellido1} name='names3' />
          </div>
          <div className='flex justify-between'>
            <label className='font-bold pr-8'>Apellido 2: </label>
            <input className='mb-2 rounded-lg px-2 ' defaultValue={apellido2} name='names4' />
          </div>
          <div className='flex justify-between'>
            <label className='font-bold pr-8'>Telefono: </label>
            <input className='mb-2 rounded-lg px-2' defaultValue={telefono} name='tel' />
          </div>
          <div className='flex justify-between'>
            <label className='font-bold pr-8'>Correo: </label>
            <input className='mb-2 rounded-lg px-2' defaultValue={correo} name='email' />
          </div>
        </form>
        {loading
          ? (
