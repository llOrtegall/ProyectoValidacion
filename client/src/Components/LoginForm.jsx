...
export const LoginForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='bg-white w-96 h-2/3 rounded-xl p-12 shadow-2xl relative flex flex-col gap-8 justify-between'>
      ...
      <br />
      {/* // TODO: usuario */}
      <input type='text' placeholder='Usuario' className='border-b-2 p-2' required onChange={ev => setUser(ev.target.value)} />
      {/* // TODO: contraseña */}
      <input type='password' placeholder='Contraseña' className='border-b-2 p-2' required onChange={ev => setPassword(ev.target.value)} />
