  ...
  return (
    <>
      ...
      <section className="fixed inset-0 flex items-center justify-center z-50">
        ...
        <article className="flex items-center py-8 border flex-col gap-4 p-4 mb-4 text-sm text-yellow-400 bg-gray-900 rounded-xl" role="alert">
          ...
          <select className='p-2 border rounded-lg text-blue-700 font-semibold cursor-pointer' onChange={ev => defineCompany(ev.target.value)}>
